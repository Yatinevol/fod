    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <nav className="container mx-auto px-6 py-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="text-2xl font-bold bg-linear-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent">
            FOD
          </span>
        </div>
      ...
      <main className="container mx-auto px-6 py-20">
        <div className="text-center max-w-4xl mx-auto mb-20">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-linear-to-r from-blue-600 via-blue-600 to-pink-600 bg-clip-text text-transparent">
            Focus on Dedication
          </h1>
